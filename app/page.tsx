...
export default function Home() {
  ...
  useEffect(() => {
    const params = {
      access_key: '20700c5307440c804a3fd81cdf8bfaf9',
      query: query,
      limit: 5,
      output: 'json'
    };
    ...
    if (lat && lng) {
      const params = {
        ...
        lon: lng,
        units: 'metric',
        appid: 'e0a1097509af391082cfcf120122e6df',
      };
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen min-h-screen text-gray-700 p-10 bg-gradient-to-br from-pink-200 via-purple-200 to-indigo-200">
      ...
      <div className="relative w-full max-w-screen-sm bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40">
        <div className="w-full relative">
          <div className="relative flex items-center w-full h-12 rounded-lg bg-white overflow-hidden ring-2 ring-gray-200 ring-opacity-40">
          ...
          {location.length > 0 && (
            <div className="absolute w-full mt-1 bg-white rounded-lg shadow-lg ring-2 ring-black ring-opacity-5">
              <ul className="divide-y divide-gray-200">
                {location.map((item: any, index: number) => (
                  <li
                    key={index}
                    className="px-4 py-4 text-sm text-gray-700 hover:rounded-lg hover:bg-gray-100 hover:text-gray-900 cursor-pointer"
                    onClick={() => {
                      getLocation(item);
                    }}
      ...
      {weather && (
        <div className="w-full max-w-screen-sm bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40 mt-10">
          <div className="flex justify-between">
            <div className="flex flex-col">
              <span className="text-6xl font-bold">{weather?.main?.temp}°C</span>
              <span className="font-semibold mt-1 text-gray-500">{weather?.name}, {weather?.sys?.country}</span>
            </div>
          ...
          <div className="flex justify-between mt-12">
            <div className="flex flex-col items-center">
              ...
              <svg className="h-10 w-10 fill-current text-gray-400 mt-3" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path d="M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79zM1 10.5h3v2H1zM11 .55h2V3.5h-2zm8.04 2.495l1.408 1.407-1.79 1.79-1.407-1.408zm-1.8 15.115l1.79 1.8 1.41-1.41-1.8-1.79zM20 10.5h3v2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm-1 4h2v2.95h-2zm-7.45-.96l1.41 1.41 1.79-1.8-1.41-1.41z" />
              </svg>
            ...
            <div className="flex flex-col items-center">
              ...
              <svg className="h-10 w-10 fill-current text-gray-400 mt-3" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
                <g>
